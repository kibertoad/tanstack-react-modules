---
name: test-module
description: Writes tests for a Reactive module using @reactive/testing with renderModule() and createMockStore(). Use when adding or updating tests for module components.
metadata:
  author: reactive
  version: "1.0"
---
...
`@reactive/testing` provides `renderModule()` to render a module in isolation with mocked shared dependencies. It uses `@testing-library/react` under the hood.
...
```typescript
import { createMockStore } from '@reactive/testing'
